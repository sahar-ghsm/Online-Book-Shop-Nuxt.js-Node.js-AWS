        ...
        <div class="row">
            ...
            <div class="nav-global-location">
              <nuxt-link to="/address" class="nav-a nav-a-2">
                ...
                <div id="glow-ingress-block">
                  ...
                  <span class="nav-line-2" id="glow-ingress-line2" v-if="$auth.$state.user && $auth.$state.user.address">{{$auth.$state.user.address.city}}</span>
                </div>              
              </nuxt-link>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
            <div class="nav-tools">
              ...
              <nuxt-link to="/orders" class="nav-a nav-a-2 nav-single-row-links">
