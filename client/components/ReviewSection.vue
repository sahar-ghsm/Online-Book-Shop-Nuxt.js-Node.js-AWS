        ...
        <div class="col-lg-6 col-md-7 col-sm-12">
          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              ...
              <!-- Reviews -->
              <div class="review-body" v-for="reveiw in reviews" :key="reveiw._id">
                <div class="genome-widget">
                  <a href="#">
                    ...
                    <div class="profile-content">
                      <span class="a-profile-name">{{reveiw.user.name}}</span>
                    </div>
                  </a>
                </div>
                <div class="a-row">
                  ...
                  <span class="a-letter-space"></span>
                  <!-- Review Headline -->
                  <a href="#" class="review-title">{{reveiw.headline}}</a>
                </div>
