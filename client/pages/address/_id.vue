              ...
              <form>
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input type="text" class="a-input-text" style="width: 100%;" :placeholder="address.fullName" v-model="fullName"/>
                  </div>
                  <!-- Street Address -->
                  <div class="a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input :placeholder="address.city" type="text" class="a-input-text" style="width: 100%;" v-model="city" />
                  </div>
                  <!-- State -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">State / Province / Region</label>
                    <input type="text" class="a-input-text" :placeholder="address.state" style="width: 100%;" v-model="state"/>
                  </div>
                  <!-- Zip Code -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">Zip Code</label>
                    <input type="text" class="a-input-text" :placeholder="address.zipCode" style="width: 100%;" v-model="zipCode"/>
                  </div>
                  <!-- Phone Number -->
                  <div class="a-spacing-top-medium">
                    <label style="margin-bottom: 0px;">Phone Number</label>
                    <input :placeholder="address.phoneNumber" type="text" class="a-input-text" style="width: 100%;" v-model="phoneNumber"/>
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input :placeholder="address.securityCode" type="text" class="a-input-text" style="width: 100%;" v-model="securityCode" />
                  </div>
                  <div class="a-spacing-top-medium">
