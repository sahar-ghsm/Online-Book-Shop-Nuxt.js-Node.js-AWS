              ...
              <div class="shipping-group">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-7 col-sm-6 col-12">
                    <div class="a-row a-spacing-base" v-for="prodct in getCart" :key="prodct._id">
                      <div class="row">
                        <!-- Product's photo -->
                        <div class="col-sm-3 col-3">
                          <img :src="prodct.photo" style="width: 100px;" />
                        </div>
                        <!-- Product's Title -->
                        <div class="col-sm-9 col-9">
                          ...
                          <div class="a-row">
                            ...
                            <span class="a-color-price a-spacing-micro">
                              <strong dir="ltr">${{prodct.price * prodct.quantity}}</strong>
                            </span>
                          </div>
                          <div class="a-row">
                          ...
                          <div class="a-row">
                            <!-- Product's quantity -->
                            <strong>Quantity: {{prodct.quantity}}</strong>
                          </div>
                          <div
